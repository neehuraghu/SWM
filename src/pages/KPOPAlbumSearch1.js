...
import styles from "./KPOPAlbumSearch1.module.css";
const KPOPAlbumSearch1 = () => {
      ...
      <div className={styles.kpopAlbumSearch}>
        ...
        <div className={styles.topPicksParent}>
          ...
          <div className={styles.groupContainer}>
            ...
            <img className={styles.groupInner} alt="" src="/vector-223.svg" />
          </div>
          <div className={styles.groupDiv}>
            ...
            <img className={styles.vectorIcon} alt="" src="/vector-225.svg" />
          </div>
          <div className={styles.groupParent1}>
            ...
            <img className={styles.groupChild2} alt="" src="/vector-218.svg" />
          </div>
        ...
        <div className={styles.image19Parent}>
          ...
          <div className={styles.searchParent}>
            ...
            <div className={styles.rectangleParent5}>
              ...
              <img className={styles.searchIcon1} alt="" src="/search3.svg" />
        ...
        <img className={styles.sideBarIcon} alt="" src="/side-bar30.svg" />
      </div>
...
export default KPOPAlbumSearch1;
