...
import styles from "./WelcomePage1.module.css";
const WelcomePage1 = () => {
  ...
  const onGroupContainer34Click = useCallback(() => {
    navigate("/wallet-page1");
  }, [navigate]);

  const onRectangle13Click = useCallback(() => {
    navigate("/search-bar1");
  }, [navigate]);
  ...
  return (
    <>
      <div className={styles.welcomePage}>
        ...
        <div className={styles.welcomePageChild} />
        <div className={styles.welcomePageItem} />
        ...
        <div className={styles.investmentStatsParent}>
          ...
          <div className={styles.groupParent}>
            <div className={styles.totalInvestmentParent}>
              ...
              <img className={styles.groupInner} alt="" src="/group-1119.svg" />
            ...
            <div className={styles.weeklyReturnsParent}>
              ...
              <img className={styles.groupInner} alt="" src="/group-1120.svg" />
            ...
            <div className={styles.expensesParent}>
              ...
              <img className={styles.groupInner} alt="" src="/group-1121.svg" />
              <div className={styles.ethFrame}>
                <div className={styles.eth2}>0.00 ETH</div>
              </div>
            </div>
            <img className={styles.groupChild2} alt="" src="/group-167.svg" />
          </div>
        </div>
        ...
        <div className={styles.topPicksParent}>
          ...
          <div className={styles.groupParent1}>
            ...
            <img className={styles.groupChild16} alt="" src="/vector-221.svg" />
          </div>
          <div className={styles.groupParent2}>
            ...
            <img className={styles.groupChild18} alt="" src="/vector-225.svg" />
          </div>
          <div className={styles.groupParent3}>
            ...
            <img className={styles.groupChild20} alt="" src="/vector-218.svg" />
          </div>
          <div className={styles.groupParent4}>
            ...
            <img className={styles.groupChild22} alt="" src="/vector-211.svg" />
          </div>
        ...
        <div className={styles.image19Parent}>
          ...
          <div className={styles.rectangleParent8}>
            <div className={styles.groupChild26} onClick={onRectangle13Click} />
        ...
        />
        <img className={styles.sideBarIcon} alt="" src="/side-bar28.svg" />
      </div>
