...
import styles from "./TutorialPage12.module.css";
const TutorialPage12 = () => {
  const navigate = useNavigate();

  const onGroupContainer2Click = useCallback(() => {
    navigate("/tutorial-page-11");
  }, [navigate]);

  return (
    <div className={styles.tutorialPage12}>
      <div className={styles.tutorialPage12Child} />
      <div className={styles.tutorialPage12Item} />
      <img className={styles.tutorialPage12Inner} alt="" src="/vector-11.svg" />
      ...
      <img className={styles.sideBarIcon} alt="" src="/side-bar7.svg" />
    </div>
  );
};

export default TutorialPage12;
