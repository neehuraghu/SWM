...
import styles from "./WalletChangesKaikas1.module.css";
const WalletChangesKaikas1 = () => {
  const navigate = useNavigate();

  const onGroupContainer2Click = useCallback(() => {
    navigate("/kaikas-connect-wallet1");
  }, [navigate]);
  ...
  return (
    <div className={styles.walletChangesKaikas}>
      ...
      <img className={styles.sideBarIcon} alt="" src="/side-bar34.svg" />
    </div>
  );
};

export default WalletChangesKaikas1;
