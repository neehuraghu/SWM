...
import LatestNewsFrame1 from "./LatestNewsFrame1";
      ...
      <div className={styles.searchBar}>
        ...
        <div className={styles.topPicksParent}>
          ...
          <div className={styles.groupParent1}>
            ...
            <img className={styles.groupChild16} alt="" src="/vector-223.svg" />
          </div>
        ...
        />
        <img className={styles.sideBarIcon} alt="" src="/side-bar29.svg" />
      </div>
