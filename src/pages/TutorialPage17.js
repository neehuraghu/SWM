...
import LatestNewsFrame from "../components/LatestNewsFrame";
import PortalPopup from "../components/PortalPopup";
import { useNavigate } from "react-router-dom";
import styles from "./TutorialPage17.module.css";
const TutorialPage17 = () => {
  const [isLatestNewsFrameOpen, setLatestNewsFrameOpen] = useState(false);
  const navigate = useNavigate();

  const onSearchTextClick = useCallback(() => {
    navigate("/tutorial-page-16");
  }, [navigate]);
  ...
  return (
    <>
      <div className={styles.tutorialPage17}>
        <img className={styles.image22Icon} alt="" src="/image-221@2x.png" />
        <div className={styles.tutorialPage17Child} />
        <div className={styles.tutorialPage17Item} />
        ...
        <div className={styles.investmentStatsParent}>
          ...
          <div className={styles.groupParent}>
            <div className={styles.totalInvestmentParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-114.svg" />
            ...
            <div className={styles.weeklyReturnsParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-115.svg" />
            ...
            <div className={styles.expensesParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-116.svg" />
              <div className={styles.ethFrame}>
                <div className={styles.eth2}>0.00 ETH</div>
              </div>
            </div>
            <img className={styles.groupChild1} alt="" src="/group-161.svg" />
          </div>
        </div>
        <div className={styles.tutorialPage17Inner} />
        ...
        <div className={styles.topPicksParent}>
          ...
          <div className={styles.groupParent1}>
            ...
            <img className={styles.groupChild15} alt="" src="/vector-210.svg" />
          </div>
          <div className={styles.groupParent2}>
            ...
            <img className={styles.groupChild17} alt="" src="/vector-26.svg" />
          </div>
          <div className={styles.groupParent3}>
            ...
            <img className={styles.groupChild19} alt="" src="/vector-27.svg" />
          </div>
          <div className={styles.groupParent4}>
            ...
            <img className={styles.groupChild21} alt="" src="/vector-211.svg" />
          </div>
        ...
        <img className={styles.sideBarIcon} alt="" src="/side-bar2.svg" />
      </div>
