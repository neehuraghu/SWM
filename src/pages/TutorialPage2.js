...
const TutorialPage2 = () => {
  ...
  return (
    <>
      <div className={styles.tutorialPage2}>
        <img className={styles.image22Icon} alt="" src="/image-221@2x.png" />
        <div className={styles.tutorialPage2Child} />
        <div className={styles.tutorialPage2Item} />
        ...
        <div className={styles.investmentStatsParent}>
          ...
          <div className={styles.groupParent}>
            <div className={styles.totalInvestmentParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-1113.svg" />
            ...
            <div className={styles.weeklyReturnsParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-1114.svg" />
            ...
            <div className={styles.expensesParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-1115.svg" />
              <div className={styles.ethFrame}>
                <div className={styles.eth2}>0.00 ETH</div>
              </div>
            </div>
            <img className={styles.groupChild1} alt="" src="/group-165.svg" />
          </div>
        </div>
        <div className={styles.tutorialPage2Inner} />
        ...
        <div className={styles.topPicksParent}>
          ...
          <div className={styles.groupParent1}>
            ...
            <img className={styles.groupChild15} alt="" src="/vector-221.svg" />
          </div>
          ...
          <div className={styles.groupParent4}>
            ...
            <img className={styles.groupChild21} alt="" src="/vector-222.svg" />
          </div>
        ...
        />
        <img className={styles.sideBarIcon} alt="" src="/side-bar20.svg" />
