...
import styles from "./TutorialPage4.module.css";
const TutorialPage4 = () => {
  const navigate = useNavigate();

  const onGroupContainer10Click = useCallback(() => {
    navigate("/tutorial-page-5");
  }, [navigate]);

  return (
    <div className={styles.tutorialPage4}>
      <div className={styles.tutorialPage4Child} />
      <div className={styles.tutorialPage4Item} />
      <img className={styles.tutorialPage4Inner} alt="" src="/vector-13.svg" />
      ...
      <img className={styles.sideBarIcon} alt="" src="/side-bar22.svg" />
    </div>
  );
};
