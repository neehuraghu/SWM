    ...
    <div className={styles.mainPage}>
      ...
      <div className={styles.topPicksParent}>
        ...
        <div className={styles.groupParent}>
          ...
          <img className={styles.groupItem} alt="" src="/vector-212.svg" />
        </div>
        <div className={styles.groupContainer}>
          ...
          <img className={styles.groupChild1} alt="" src="/vector-213.svg" />
        </div>
        ...
        <div className={styles.groupParent1}>
          ...
          <img className={styles.groupChild4} alt="" src="/vector-214.svg" />
        </div>
        <div className={styles.groupParent2}>
          ...
          <img className={styles.groupChild6} alt="" src="/vector-215.svg" />
        </div>
      </div>
      ...
      <img className={styles.sideBarIcon} alt="" src="/side-bar18.svg" />
    </div>
  );
};
