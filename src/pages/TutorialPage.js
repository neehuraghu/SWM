  ...
  return (
    <>
      <div className={styles.tutorialPage}>
        ...
        <div className={styles.investmentStatsParent}>
          ...
          <div className={styles.groupParent}>
            <div className={styles.totalInvestmentParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-111.svg" />
            ...
            <div className={styles.weeklyReturnsParent}>
              ...
              <img className={styles.groupItem} alt="" src="/group-112.svg" />
            ...
            <img className={styles.groupChild1} alt="" src="/group-16.svg" />
          </div>
        </div>
        ...
        <img className={styles.sideBarIcon} alt="" src="/side-bar1.svg" />
      </div>
