...
const TutorialPage16 = () => {
  ...
  return (
    <>
      <div className={styles.tutorialPage16}>
        ...
        <div className={styles.tutorialPage16Child} />
        <div className={styles.tutorialPage16Item} />
        <img
          className={styles.tutorialPage16Inner}
          alt=""
          src="/vector-11.svg"
        />
        ...
        <div className={styles.topPicksParent}>
          ...
          <div className={styles.groupContainer}>
            ...
            <img className={styles.groupItem} alt="" src="/vector-25.svg" />
          </div>
          ...
          <div className={styles.groupParent1}>
            ...
            <img className={styles.groupChild1} alt="" src="/vector-27.svg" />
          </div>
          <div className={styles.groupParent2}>
            ...
            <img className={styles.groupChild3} alt="" src="/vector-28.svg" />
          </div>
        ...
        <img className={styles.sideBarIcon} alt="" src="/side-bar3.svg" />
      </div>
