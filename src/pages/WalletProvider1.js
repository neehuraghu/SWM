import styles from "./WalletProvider1.module.css";
const WalletProvider1 = () => {
  return (
    <div className={styles.walletProvider}>
      <div className={styles.walletProviderChild} />
      <div className={styles.walletProviderItem} />
      <img className={styles.walletProviderInner} alt="" src="/vector-13.svg" />
      ...
      <img className={styles.ellipseIcon} alt="" src="/property-1default.svg" />
      <img
        className={styles.walletProviderChild1}
        alt=""
        src="/property-1default1.svg"
      />
      <img
        className={styles.walletProviderChild2}
        alt=""
        src="/property-1default1.svg"
      />
      <img
        className={styles.walletProviderChild3}
        alt=""
        src="/property-1default1.svg"
      />
      ...
      <img className={styles.sideBarIcon} alt="" src="/side-bar32.svg" />
    </div>
  );
};

export default WalletProvider1;
