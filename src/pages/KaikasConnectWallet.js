...
import styles from "./KaikasConnectWallet.module.css";
const KaikasConnectWallet = () => {
  ...
  return (
    <div className={styles.kaikasConnectWallet}>
      ...
      <img className={styles.sideBarIcon} alt="" src="/side-bar17.svg" />
    </div>
  );
};

export default KaikasConnectWallet;
