      ...
      <div className={styles.welcomePage}>
        ...
        <div className={styles.investmentStatsParent}>
          ...
          <div className={styles.groupParent}>
            ...
            <img className={styles.groupChild2} alt="" src="/group-161.svg" />
          </div>
        </div>
        ...
        <div className={styles.topPicksParent}>
          ...
          <div className={styles.groupParent1}>
            ...
            <img className={styles.groupChild16} alt="" src="/vector-210.svg" />
          </div>
        ...
        />
        <img className={styles.sideBarIcon} alt="" src="/side-bar10.svg" />
      </div>
