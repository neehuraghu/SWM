...
import styles from "./TutorialPage10.module.css";
const TutorialPage10 = () => {
  const navigate = useNavigate();

  const onRectangle12Click = useCallback(() => {
    navigate("/tutorial-page-17");
  }, [navigate]);
  ...
  return (
    <div className={styles.tutorialPage10}>
      <img className={styles.image22Icon} alt="" src="/image-221@2x.png" />
      <div className={styles.tutorialPage10Child} />
      <div className={styles.tutorialPage10Item} />
      ...
      <div className={styles.investmentStatsParent}>
        ...
        <div className={styles.groupParent}>
          <div className={styles.totalInvestmentParent}>
            ...
            <img className={styles.groupItem} alt="" src="/group-117.svg" />
          ...
          <div className={styles.weeklyReturnsParent}>
            ...
            <img className={styles.groupItem} alt="" src="/group-118.svg" />
          ...
          <div className={styles.expensesParent}>
            ...
            <img className={styles.groupItem} alt="" src="/group-119.svg" />
            <div className={styles.ethFrame}>
              <div className={styles.eth2}>0.00 ETH</div>
            </div>
          </div>
          <img className={styles.groupChild1} alt="" src="/group-162.svg" />
        </div>
      </div>
      <div className={styles.tutorialPage10Inner} />
      ...
      <div className={styles.topPicksParent}>
        ...
        <div className={styles.groupParent4}>
          ...
          <img className={styles.groupChild21} alt="" src="/vector-28.svg" />
        </div>
      ...
      <img className={styles.sideBarIcon} alt="" src="/side-bar9.svg" />
    </div>
  );
};

export default TutorialPage10;
